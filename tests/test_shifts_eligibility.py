...
def test_no_period_covers_date() -> None:
    res = is_eligible(
        _person(),
        [_period(date(2026, 6, 1), date(2026, 6, 5))],
        shift_date=date(2026, 6, 10),
        kind=ShiftKind.NOON,
        slot="operator",
    )
...
def test_arrival_day_morning_blocked() -> None:
    res = is_eligible(
        _person(),
        [_period(date(2026, 6, 10), date(2026, 6, 20))],
        shift_date=date(2026, 6, 10),
        kind=ShiftKind.MORNING,
        slot="operator",
    )
...
def test_last_day_night_allowed() -> None:
    res = is_eligible(
        _person(),
        [_period(date(2026, 6, 1), date(2026, 6, 10))],
        shift_date=date(2026, 6, 10),
